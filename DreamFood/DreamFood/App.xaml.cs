    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            if (Settings.IsRemembered && !string.IsNullOrEmpty(Settings.AccessToken))
            {
                ...
                mainViewModel.Restaurants = new RestaurantsViewModel();
                mainViewModel.Recommendations = new RecommendationViewModel();
                this.MainPage = new NavigationPage(new NavigationTabbedPage());
            }
            else
            {
                ...
                //{
                //    BarBackgroundColor = Color.FromHex("#008C8C"),
