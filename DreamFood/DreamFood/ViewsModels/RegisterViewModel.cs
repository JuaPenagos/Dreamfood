...
namespace DreamFood.ViewsModels
{
    public class RegisterViewModel : BaseViewModel
    {
        ...
        private async void Save()
        {
            ...
            if (string.IsNullOrEmpty(this.TypeRestaurant))
            {
                await Application.Current.MainPage.DisplayAlert(
                    Languages.Error,
                    Languages.TypeRestaurantError,
                    Languages.Accept);
                return;
            }

            if (string.IsNullOrEmpty(this.DistanceRestaurant))
            {
                await Application.Current.MainPage.DisplayAlert(
                    Languages.Error,
                    Languages.DistanceRestaurantError,
                    Languages.Accept);
                return;
            }

            if (string.IsNullOrEmpty(this.WordKey))
            {
                await Application.Current.MainPage.DisplayAlert(
                    Languages.Error,
                    Languages.WordKeyError,
                    Languages.Accept);
                return;
            }
            ...
            var userRequest = new UserRequest
            {
                ...
                DistanceRestaurant=this.DistanceRestaurant,
